...
import 'test_deatails.dart';
import 'qustion_bank.dart';
import 'rto_office.dart';
    ...
    RTO(
        ...
        onTap: (context) {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const TestDetails()));
        }),
    RTO(
        icon: Icons.book,
        ...
        onTap: (context) {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const QustionBank()));
        }),
    RTO(
        ...
        onTap: (context) {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const TrafficSigns()));
        }),
    RTO(
        icon: Icons.computer,

...
class TestDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String mcqTest =
        '''15 questions are asked in the test at random, out of which 11 questions are required to be answered correctly to pass the test. 48 seconds are allowed to answer each question.''';
    String drivingLicenceTest =
    ...
    String eligibilityOfDrivingLicenceinGujarat =
        '''To apply for a two-wheeler gearless vehicle DL, a person needs to be 16 years of age or above.
To apply for a geared motor vehicle DL, a person needs to be 18 years of age or above.
To apply for a heavy transport motor vehicle DL, a person needs to be 20 years of age or above.''';
    return Scaffold(
      appBar: AppBar(
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      "Eligibility for Driving Licence in Gujarat :",
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.w600),
                    ),
                    Padding(
